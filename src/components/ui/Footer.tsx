  ...
  return (
    <footer className="border-t border-[#1e2538]/50 py-8 mt-auto relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center text-sm text-[#4a5568] relative">
        <p>
          <span className="text-[#6b7a94]">Tử Vi Đẩu Số</span> &mdash; Luận giải chuyên sâu bằng trí tuệ nhân tạo
        </p>
        <p className="mt-1 text-[#3d4a5c]">
          Kết quả mang tính tham khảo. Vận mệnh nằm trong tay bạn.
        </p>
      </div>
    </footer>
  );
