...
// ============================================================
// PROMPT PACK — vi (the origin locale)
// ============================================================
//
// Verbatim from the pre-P5 `gemini.ts` and `api/chat/route.ts`: same
// methodology, same eleven-section output template, same self-check. The
// Vietnamese reading must not change in this phase, so nothing here is
// reworded — the other four packs are translations of exactly this.

const vi: PromptPack = {
  system: `Bạn là ĐẠI SƯ TỬ VI ĐẨU SỐ kiêm CHUYÊN GIA BÁT TỰ (Tứ Trụ) — bậc thầy luận số hàng đầu với hơn 40 năm kinh nghiệm thực chiến cả hai hệ thống Tử Vi Đẩu Số và Bát Tự Mệnh Lý (Four Pillars of Destiny). Đào tạo chính quy theo trường phái Tử Vi chính tông Việt Nam, Đài Loan (dòng Trung Châu phái) và Hồng Kông, kết hợp sâu tâm lý học hành vi hiện đại, thống kê xã hội học, và dịch lý Đông phương.
...
- Tổng bài luận giải phải đạt tối thiểu 5000 từ.`,
  ...
  cacheSeed:
    'Đây là tài liệu tham khảo chuyên sâu về Tử Vi Đẩu Số. Hãy sử dụng kiến thức từ tài liệu này để phân tích lá số chính xác và chi tiết hơn. Khi phân tích, ưu tiên phương pháp và quy tắc trong tài liệu này.',
...
- Sử dụng kiến thức từ tài liệu tham khảo Tử Vi đã được cung cấp để phân tích chính xác hơn.`,
  ...
  labels: {
    ...
    timezoneNote: '(GMT+7 — Việt Nam)',
    basics: 'THÔNG TIN CƠ BẢN',
    name: 'Tên',
    gender: 'Giới tính',
    notGiven: '(không cung cấp)',
    solar: 'Dương lịch',
    lunar: 'Âm lịch',
    canChi: 'Can Chi',
    birthHour: 'Giờ sinh',
    ...
    soul: 'Mệnh chủ',
    body: 'Thân chủ',
    soulPalaceAt: 'Cung Mệnh tại',
    bodyPalaceAt: 'Cung Thân tại',
    twelvePalaces: '12 CUNG',
    bodyPalaceMark: '[★THÂN CUNG]',
    canChiOf: 'Can/Chi',
    changsheng: 'Trường sinh',
    decadal: 'Đại hạn',
    majorStars: 'Chính tinh',
    minorStars: 'Phụ tinh',
    adjectiveStars: 'Tạp diệu',
    empty: '— trống —',
    none: '(không có)',
    horoscopeHead: 'VẬN HẠN HIỆN TẠI',
    decadalRow: 'Đại hạn',
    yearlyRow: 'Lưu niên',
    ...
    baziDay: 'Ngày trụ',
    baziHour: 'Giờ trụ',
    baziDayMasterMark: '← NHẬT CHỦ',
    baziBranch: 'Chi',
    baziDayMaster: 'Nhật chủ (Day Master)',
    baziStrength: 'Cường/Nhược',
    baziScore: 'Score',
    baziFiveElements: 'Ngũ hành phân bố',
    baziFavorable: 'Dụng thần (Favorable)',
    baziUnfavorable: 'Kỵ thần (Unfavorable)',
    baziUndetermined: '(không xác định)',
    baziNobleman: 'Quý nhân (貴人)',
    baziPeachBlossom: 'Đào hoa (桃花)',
    baziSkyHorse: 'Thiên mã (天馬)',
    baziIntelligence: 'Văn xương (文昌)',
    baziInteractions: 'Tương tác trụ',
    baziLuck: 'Đại vận Bát Tự',
    baziForward: 'Thuận',
    baziBackward: 'Nghịch',
    baziStartAt: 'khởi',
    selfHead: 'MÔ TẢ BẢN THÂN (do người dùng cung cấp)',
